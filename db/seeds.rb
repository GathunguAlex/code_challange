...
#   )
# end
review1 =Review.create(star_rating: 9, comment: "nice", user_id: 1, product_id: 1)
review1 =Review.create(star_rating: 5, comment: "nice", user_id: 1, product_id: 3)
review1 =Review.create(star_rating:3, comment: "nice", user_id: 3, product_id: 1)
review1 =Review.create(star_rating: 1, comment: "nice", user_id: 2, product_id: 2)
